...
export default async function BookingDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [reservation, rooms] = await Promise.all([getReservation(id), getRooms()]);
  ...
  return (
    <>
      <PageHeader eyebrow="Reservation" title="Booking Detail" description="View the full reservation, audit history, and edit or cancel if permitted." />
