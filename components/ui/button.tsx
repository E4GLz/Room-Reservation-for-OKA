  ...
  return (
    <button
      className={cn(
        ...
        variant === "secondary" && "bg-white text-slate-900 ring-1 ring-inset ring-[var(--line)] hover:bg-[#f7faff]",
        variant === "ghost" && "bg-[var(--accent-soft)] text-[var(--accent)] ring-1 ring-inset ring-[#d6e2ff] hover:bg-[#dce8ff]",
